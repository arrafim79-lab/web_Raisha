...
<div class="flex">
    ...
    <div id="sidebar"
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-lg font-bold">Raisha Lutfia Khairani</h2>
        ...
        <div class="flex justify-center space-x-3 mb-8">
            ...
            <a href="https://instagram.com/ic_chaaxya_" target="_blank"
            ...
            <a href="https://tiktok.com/@chaa0529" target="_blank"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center w-full">
                ...
                <div>
                    ...
                    <h2 class="text-xl font-semibold mb-4">
                        Saya <span class="text-cyan-400">Raisha Lutfia Khairani</span>, Mahasiswa
                    </h2>
...
<div id="modal1" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50">
    <div class="bg-white text-black p-6 rounded-lg w-[90%] md:w-[500px] relative">
        ...
        <p>
            Hari pertama lebaran saya sholat eid di lapangan dekat rumah lalu kami berkumpul dan bersalam-salaman sesama keluarga,
            setelah itu kami berfoto-foto dan bersilaturahmi ke rumah keluarga dari ayah,
            makan ketupat, dan saling bermaafan satu sama lain.
        </p>
    </div>
</div>
...
<div id="modal2" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50">
    <div class="bg-white text-black p-6 rounded-lg w-[90%] md:w-[500px] relative">
        ...
        <p>
            Hari kedua lebaran saya berangkat dari kampung ayah ke kampung bunda setelah sampai disana,kami 
            bersilaturahmi ke rumah keluarga dari bunda dan pergi ke acara melakek an gala .
        </p>
    </div>
</div>
...
<div id="modal3" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50">
    <div class="bg-white text-black p-6 rounded-lg w-[90%] md:w-[500px] relative">
        ...
        <p>
            Hari ketiga saya dan keluarga, kami pergi kerumah keluarga istri dari abang dan lanjut jalan-jalan bersama sepupu 
        </p>
    </div>
</div>
